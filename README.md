...
**Author:** [vatsayu](https://github.com/vatsayu)  
**Platform:** [Blue Team Labs Online](https://blueteamlabs.online)  
**Focus:** Free-tier Blue Team challenges only  

This repository contains my detailed write-ups while learning Blue Team skills through BTLO challenges.  
I am following a structured phase-based approach to build strong fundamentals.
...
## Phase 1 – Security Operations & Incident Response (Easy)
...
## Phase 2 – Digital Forensics (Easy)
...
## Phase 3 – Reverse Engineering (Easy)

**Goal:** Understand basic malware behavior, PowerShell, macros, and injection techniques.

| # | Challenge Name                          | Category            | Difficulty | Status  | Write-up |
|---|-----------------------------------------|---------------------|------------|---------|----------|
| 1 | PowerShell Analysis - Keylogger         | Reverse Engineering | Easy       | Pending | - |
| 2 | Malware Analysis - Ransomware Script    | Reverse Engineering | Easy       | Pending | - |
| 3 | ILOVEYOU                                | Reverse Engineering | Easy       | Pending | - |
| 4 | Melissa                                 | Reverse Engineering | Easy       | Pending | - |
| 5 | Reverse Engineering - Another Injection | Reverse Engineering | Easy       | Pending | - |
| 6 | Injection Series Part 4                 | Reverse Engineering | Easy       | Pending | - |

---

## Phase 4 – Threat Intelligence + CTF Warm-up

| # | Challenge Name | Category            | Difficulty | Status  | Write-up |
|---|----------------|---------------------|------------|---------|----------|
| 1 | ThePackage     | Threat Intelligence | Easy       | Pending | - |
| 2 | D3FEND         | CTF-Like            | Easy       | Pending | - |
...
- **Mozilla Thunderbird** – Safe email viewing
